        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav">
                ...
                <a id='navAuditorium' class="nav-link active">
                   ...
                   <a id='navRC' href="https://foreng.wika.co.id/news" target="__blank" class="nav-link active" style="width: fit-content;">
            ...
            <div class="row">
                <div class="col-5  embed-responsive embed-responsive-16by9 centered-thing"> Youtube
                    <iframe id='auditoriumVideo' width="560" height="315"
                        src="https://www.youtube.com/embed/7LeOx-XLWEw?autoplay=0; controls=0;"
                ...
                <div class="row">
                    <div class="col transbox">
                        <p>Forum Engineering is WIKA's annual event. This Years theme is about "Future Solution for
                            Lifecycle Construction", present newest technology which more productive and efficient on
                            construction's industry. There are echibitions by WIKA's departements, subsidaries, and
                            partners. <a class="aboutForeng" href="https://foreng.wika.co.id/about" target="_blank">Read
                                more</a>
                        </p>
                    </div>
                </div>
