                ...
                <div class="row">
                    <div class="col" style="margin-top:25.62%; margin-left:21.1%">
                        <img src="/assets/photos/mandiri.png" id="modalButton" data-toggle="modal"
                            data-target="#exampleModal" width="34.5%" height="200%">
                    </div>
                    <div class="col vidSponsor" style="margin-top: 2%;">
                        <iframe style="margin-left: 6%;" src="https://www.youtube.com/embed/0Zoutxtslvw?autoplay=0"
                            frameborder="0" allowfullscreen></iframe>
                    </div>
                    <div class="col" style="margin-top:25%; margin-left:-30%">
                        <img src="/assets/photos/mandiri.png" id="modalButton" data-toggle="modal"
                            data-target="#exampleModal" width="34.5%" height="200%">
                    </div>
                </div>
